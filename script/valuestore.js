let valuestores =[
    ...
    {
        img:"https://cdn01.pharmeasy.in/dam/products_otc/D92359/everherb-by-pharmeasy-amla-juice-rich-in-vitamin-c-natural-immunity-booster-1-litre-bottle-2-1654169607.jpg?dim=700x0&dpr=1&q=100://cdn01.pharmeasy.in/dam/products/M15866/kidrich-d3-bottle-of-5ml-oral-solution-1-1663157621.jpg?dim=1440x0",
        title:"Everherb (By Pharmeasy)<br> Amla Juice-Rich...",
        price:"MRP ₹199.5",
        tax:"Inclusive of all taxes",
        offer:"50% OFF"
    },
...
localStorage.setItem("valuestorescart",JSON.stringify(valuestores))

let valuestoresdata=JSON.parse(localStorage.getItem("valuestorescart"))||[];

 console.log(valuestoresdata)

displayValuestores(valuestoresdata)


function displayValuestores(valuestoresdata){

    let container1=document.getElementById("valuestore2")

    valuestoresdata.forEach((el,index)=>{
   
     let card=document.createElement("div")
     card.setAttribute("id","card")
     card.addEventListener("click",function(){

        localStorage.setItem("productlist",JSON.stringify(valuestoresdata[index]))
...
// function lh(){
//     let sortlh= valuestores.sort(function(a,b){
